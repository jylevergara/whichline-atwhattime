        ...
        $.extend(Plugin.prototype, {
            ...
            getYoutubeVideo: function(random) {
                var keyword = this.getYoutubeKeyword(random),
                    yt_url = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=" + keyword + "&maxResults=1&order=viewCount&key=AIzaSyA5e6ZDR11n29N-LNA2tyOkbtPwO2svaHc",
                    base = this;
                this.getAjax(yt_url, function(data) {
                    ...
                    if (response.items.length > 0 && "undefined" != typeof response.items[0].id) {
                        var video_id = response.items[0].id.videoId,
                            ...
                            video_frame = "<iframe class='embed-responsive-item' src='https://www.youtube.com/embed/" + video_id + "?enablejsapi=1&origin=http://youtube.onlinealarmkur.com&rel=0&loop=1&playlist=" + video_id + "' frameborder='0' type='text/html'></iframe>",
