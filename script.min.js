function loadJSON(callback, lang) {
    ...
    request.overrideMimeType("application/json"), request.open("GET", "http://onlinealarmkur.com/assets/privacy/" + lang + ".json", !0), request.onreadystatechange = function() {
        4 === request.readyState && 200 === request.status && callback(request.responseText)
    }, request.send(null)
}

function doModal(title, close, content) {
    html = '<div id="dynamicModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="confirm-modal" aria-hidden="true">', html += '<div class="modal-dialog">', html += '<div class="modal-content">', html += '<div class="modal-header">', html += '<a class="close" data-dismiss="modal">&times;</a>', html += '<h3 class="modal-title">' + title + "</h3>", html += "</div>", html += '<div class="modal-body">', html += content, html += "</div>", html += '<div class="modal-footer">', html += '<button type="button" class="btn btn-default" data-dismiss="modal">' + close + "</button>", html += "</div>", html += "</div>", html += "</div>", html += "</div>", $("body").append(html), $("#dynamicModal").modal(), $("#dynamicModal").modal("show"), $("#dynamicModal").on("hidden.bs.modal", function(e) {
        $(this).remove()
    })
}

function showPrivacy(code, title, close, siteTitle, siteEmail) {
    loadJSON(function(response) {
        var json = JSON.parse(response),
            html = "";
        $.each(json, function(i, content) {
            "undefined" != typeof content.header && (html += "<h3>" + content.header + "</h3>"), html += "<p>" + content.content + "</p>"
        }), html = html.replace(new RegExp("{SITE_TITLE}", "gi"), siteTitle), html = html.replace(new RegExp("{CONTACT_EMAIL}", "gi"), siteEmail), html = html.replace(/((http|https|ftp):\/\/[\w?=&.\/-;#~%-]+(?![\w\s?&.\/;#~%"=-]*>))/g, '<a target="_blank" rel="noopener noreferrer" href="$1">$1</a> '), doModal(title, close, html)
    }, code)
}
if (! function(a, b) {
        "use strict";
        ...
        var c = [],
            ...
            n = m.call(Object),
            o = {},
            q = "3.2.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector",
            r = function(a, b) {
        ...
        r.extend({
            ...
            promise: function(a, b) {
                ...
                for ("string" != typeof a && (b = a, a = void 0), a = a || "fx"; g--;) c = W.get(f[g], a + "queueHooks"), c && c.empty && (d++, c.empty.add(h));
        ...
        r.fn.extend({
            val: function(a) {
                ...
                })) : e ? (b = r.valHooks[e.type] || r.valHooks[e.nodeName.toLowerCase()], b && "get" in b && void 0 !== (c = b.get(e, "value")) ? c : (c = e.value, "string" == typeof c ? c.replace(fb, "") : null == c ? "" : c)) : void 0
            }
        }), r.extend({
            valHooks: {
                option: {
        ...
        r.extend(r.event, {
            trigger: function(b, c, e, f) {
                ...
                if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !gb.test(p + r.event.triggered) && (p.indexOf(".") > -1 && (q = p.split("."), p = q.shift(), q.sort()), k = p.indexOf(":") < 0 && "on" + p, b = b[r.expando] ? b : new r.Event(p, "object" == typeof b && b), b.isTrigger = f ? 2 : 3, b.namespace = q.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : r.makeArray(c, [b]), n = r.event.special[p] || {}, f || !n.trigger || n.trigger.apply(e, c) !== !1)) {
                    ...
                    for (g = 0;
                        (h = o[g++]) && !b.isPropagationStopped();) b.type = g > 1 ? j : n.bindType || p, m = (W.get(h, "events") || {})[b.type] && W.get(h, "handle"), m && m.apply(h, c), m = k && h[k], m && m.apply && U(h) && (b.result = m.apply(h, c), b.result === !1 && b.preventDefault());
...
function() {
    ...
    o.prototype = {
        ...
        _startFadeInterval: function(e, n, o, t, r) {
            var a = this,
                ...
                _ = d / .01,
                s = _ > 0 ? t / _ : t;
            s < 4 && (_ = Math.ceil(_ / (4 / s)), s = 4), e._interval = setInterval(function() {
                _ > 0 && (u += "in" === i ? .01 : -.01), u = Math.max(0, u), u = Math.min(1, u), u = Math.round(100 * u) / 100, a._webAudio ? (void 0 === r && (a._volume = u), e._volume = u) : a.volume(u, e._id, !0), (o < n && u <= o || o > n && u >= o) && (clearInterval(e._interval), e._interval = null, a.volume(o, e._id), a._emit("fade", e._id))
            }, s)
        },
        ...
        e.VERSION = "1.7.7", e.DEFAULTS = {
            ...
            selectPosition: function() {
                ...
                this.$newElement.on("click", function() {
                    var b = a(this);
                    d.isDisabled() || (e(b), d.$bsContainer.appendTo(d.options.container).toggleClass("open", !b.hasClass("open")).append(d.$menu))
    ...
    return {
        ...
        hasKey: function(a) {
            return !(!n || !n.hasOwnProperty(a) || "__simpleStorage_meta" === a)
        },
        get: function(a) {
            return !!n && (n.hasOwnProperty(a) && "__simpleStorage_meta" !== a && this.getTTL(a) ? n[a] : void 0)
        },
        deleteKey: function(a) {
            return !!(n && a in n) && (delete n[a], h(a, 0), e())
        },
        setTTL: function(a, b) {
            return !!n && (h(a, b), e())
        },
        getTTL: function(a) {
            var b;
            return !(!n || !n.hasOwnProperty(a)) && (n.__simpleStorage_meta && n.__simpleStorage_meta.TTL && n.__simpleStorage_meta.TTL.expire && n.__simpleStorage_meta.TTL.expire.hasOwnProperty(a) ? (b = Math.max(n.__simpleStorage_meta.TTL.expire[a] - +new Date || 0, 0), b || !1) : 1 / 0)
        },
        flush: function() {
            if (!n) return !1;
            n = {};
...
function() {
    ...
    function K(a, b, c) {
        a.j && a.h[b] && (c ? a.h[b](c.c, J(c)) : a.h[b]())
    }
    ...
    function U(a) {
        var d, b = a.g.a.offsetWidth,
            c = a.h.a.offsetWidth;
        (d = b === a.f.serif && c === a.f["sans-serif"]) || (d = T() && la(a, b, c)), d ? q() - a.A >= a.w ? T() && la(a, b, c) && (null === a.u || a.u.hasOwnProperty(a.a.c)) ? V(a, a.v) : V(a, a.B) : ma(a) : V(a, a.v)
    }
            ...
            if (0 === c.length && f) L(b.a);
                ...
                for (h = 0; h < c.length; h++) {
                    var k = c[h],
                        ...
                        r = b.a,
                        x = k;
                    if (r.g && w(r.f, [r.a.c("wf", x.c, J(x).toString(), "loading")]), K(r, "fontloading", x), r = null, null === X)
                        if (window.FontFace) {
                            var x = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent),
                                xa = /OS X.*Version\/10\..*Safari/.exec(window.navigator.userAgent) && /Apple/.exec(window.navigator.vendor);
                            X = x ? 42 < parseInt(x[1], 10) : !xa
                        } else X = !1;
                    r = X ? new P(p(b.g, b), p(b.h, b), b.c, k, b.s, n) : new Q(p(b.g, b), p(b.h, b), b.c, k, b.s, a, n), l.push(r)
                }
    ...
    function Da(a) {
        for (var b = a.f.length, c = 0; c < b; c++) {
                    ...
                    for (var m = m.split(","), h = m.length, l = 0; l < h; l++) {
                        ...
                        if (k = m[l], k.match(/^[\w-]+$/)) {
                            ...
                            if (null == n) k = "";
                                ...
                                if (k = n[2], k = null == k || "" == k ? "n" : Ba[k], n = n[1], null == n || "" == n) n = "4";
                                else var r = Aa[n],
            ...
            for (a.c[e] || (d = za[e]) && (a.c[e] = d), d = 0; d < f.length; d += 1) a.a.push(new G(e, f[d]))
        }
    }
    ...
    W.prototype.g = function(a) {
        var b = this.a;
        b.g && w(b.f, [b.a.c("wf", a.c, J(a).toString(), "active")], [b.a.c("wf", a.c, J(a).toString(), "loading"), b.a.c("wf", a.c, J(a).toString(), "inactive")]), K(b, "fontactive", a), this.m = !0, na(this)
        ...
        if (b.g) {
            ...
            c || d.push(b.a.c("wf", a.c, J(a).toString(), "inactive")), w(b.f, d, e)
        }
        ...
        var b, c, d = this.a.urls || [],
            ...
            g = new B;
        for (b = 0, c = d.length; b < c; b++) z(this.c, d[b], C(g));
        var m = [];
    ...
    Ea.prototype.load = function(a) {
        ...
        va(d, e);
        var f = new ya(e);
        Da(f), z(c, wa(d), C(b)), E(b, function() {
            a(f.a, f.c, Fa)
        })
...
function($) {
    $.fn.stupidtable = function(sortFns) {
        return this.each(function() {
            var $table = $(this);
            sortFns = sortFns || {}, sortFns = $.extend({}, $.fn.stupidtable.default_sort_fns, sortFns), $table.data("sortFns", sortFns), $table.on("click.stupidtable", "thead th", function() {
                $(this).stupidsort()
            });
        ...
        var $this_th = $(this),
            ...
            datatype = $this_th.data("sort") || null;
        if (null !== datatype) {
            ...
            var sort_dir;
            return 1 == arguments.length ? sort_dir = force_direction : (sort_dir = force_direction || $this_th.data("sort-default") || dir.ASC, $this_th.data("sort-dir") && (sort_dir = $this_th.data("sort-dir") === dir.ASC ? dir.DESC : dir.ASC)), $this_th.data("sort-dir", sort_dir), $table.trigger("beforetablesort", {
                column: th_index,
                direction: sort_dir,
                $th: $this_th
            }), $table.css("display"), setTimeout(function() {
                var column = [],
                ...
                trs.each(function(index, tr) {
                    ...
                    if ("undefined" == typeof sort_val) {
                        var txt = $e.text();
                        $e.data("sort-value", txt), sort_val = txt
                    }
                    column.push([sort_val, tr, index])
                }), column.sort(function(a, b) {
                    var diff = sortMethod(a[0], b[0]);
                    return 0 === diff ? a[2] - b[2] : diff
                }), sort_dir != dir.ASC && column.reverse(), trs = $.map(column, function(kv) {
                    return kv[1]
                }), $table.children("tbody").append(trs), $table.find("th").data("sort-dir", null).removeClass("sorting-desc sorting-asc"), $this_th.data("sort-dir", sort_dir).addClass("sorting-" + sort_dir), $table.trigger("aftertablesort", {
                    column: th_index,
                    direction: sort_dir,
                    $th: $this_th
                }), $table.css("display")
        ...
        var $this_td = $(this);
        return $this_td.is("[data-sort-value]") && $this_td.attr("data-sort-value", new_sort_val), $this_td.data("sort-value", new_sort_val), $this_td
    }, $.fn.stupidtable.dir = {
        ASC: "asc",
        DESC: "desc"
        ...
        "string-ins": function(a, b) {
            return a = a.toString().toLocaleLowerCase(), b = b.toString().toLocaleLowerCase(), a.localeCompare(b)
        }
    }
}(jQuery), $("#cookie").length && (simpleStorage.get("online-alarm-kur-eu-cookies") || $("#cookie").removeClass("hidden"), $(".cookie-close").click(function() {
        $("#cookie").addClass("hidden"), simpleStorage.set("online-alarm-kur-eu-cookies", !0)
    })),
    function($) {
        ...
        function Stopwatch(updateFunction, autostart) {
            return "function" == typeof this || this.init ? new Stopwatch(updateFunction, autostart) : (this.set(updateFunction, autostart), this)
        }

        function Countdown(updateFunction, countdown) {
            return "function" == typeof this || this.init ? new Countdown(updateFunction, countdown) : (this.set(updateFunction, countdown), this)
        }
        ...
        function formatTime(time) {
            var min = parseInt(time / 6e4),
                sec = parseInt(time / 1e3) - 60 * min,
                hundredths = pad(parseInt(time / 10 - 100 * sec - 6e3 * min), 2);
            return (min > 0 ? pad(min, 2) : "00") + ":" + pad(sec, 2) + ":" + hundredths
        }
        $.timer = Timer, $.stopwatch = Stopwatch, $.countdown = Countdown, $.timerUtil = {
            pad: pad,
            ...
            "function" == typeof updateFunction && (this.init = !0, this.updateFunction = updateFunction, this.startTime = 0, this.pauseStart = 0, 0 != autostart && (this.startTime = (new Date).getTime(), this.setInterval()))
        }, Stopwatch.prototype.timeUpdate = function() {
            0 == this.startTime ? this.timePassed = 0 : this.timePassed = (new Date).getTime() - this.startTime, this.updateFunction.apply(this)
            ...
            this.clearInterval(), this.startTime = 0, this.timeUpdate()
        }, Stopwatch.prototype.pause = function() {
            this.clearInterval(), this.pauseStart = (new Date).getTime(), this.timeUpdate()
        }, Stopwatch.prototype.toggle = function() {
            this.pauseStart || 0 == this.startTime ? this.start() : this.pause()
        }, Stopwatch.prototype.setInterval = function() {
            function interval() {
                self.timeUpdate()
            }
            this.clearInterval(), this.interval = setInterval(interval, 1e3 / 30);
            var self = this
            ...
            if (this.startTime) {
                ...
                this.startTime += (new Date).getTime() - this.pauseStart, this.pauseStart = 0
            } else this.startTime = (new Date).getTime();
            this.setInterval()
        }, Countdown.prototype = new Stopwatch, Countdown.prototype.setCountdown = function(countdown) {
            this.countdown = 1e3 * countdown
        }, Countdown.prototype.set = function(updateFunction, countdown) {
            this.setCountdown(countdown), Stopwatch.prototype.set.apply(this, [updateFunction])
        }, Countdown.prototype.getTime = function() {
            var time = this.countdown - Stopwatch.prototype.getTime.apply(this);
            return time <= 0 ? (time = 0, this.finished = !0, this.startTime = 0, this.clearInterval()) : this.finished = !1, time
        }, Countdown.prototype.isFinished = function() {
            return this.finished
        }, Countdown.prototype.start = function() {
            0 == this.getTime() && (this.startTime = 0), Stopwatch.prototype.start.apply(this)
        }
    }(jQuery),
    function($) {
        $.fn.allofthelights = function(options) {
            function calculating() {
                var x = [],
                    ...
                    id = 1,
                    callback_turn_off = !0;
                x.push(0), x.push($(document).width()), y.push(0), y.push($(document).height());
                for (var i = 0; i < $elements.length; ++i) {
                    var $video = $elements[i],
                        offset = $video.offset(),
                        height = $video.height(),
                        width = $video.width();
                    x.push(offset.left), x.push(offset.left + width), y.push(offset.top), y.push(offset.top + height)
                }
                x.sort(function(a, b) {
                    return a - b
                }), y.sort(function(a, b) {
                ...
                for (var i = 0; i < x.length - 1; ++i)
                    for (var j = 0; j < y.length - 1; ++j) {
                        for (var ax = x[i], ay = y[j], bx = x[i + 1], by = y[j + 1], to_display = !0, k = 0; k < $elements.length; ++k) {
                            var $video = $elements[k],
                                ...
                                vax = offset.left,
                                vay = offset.top,
                                vbx = offset.left + width,
                                vby = offset.top + height;
                ...
                $("div.allofthelights_bg").is(":visible") || $(".allofthelights_bg").show(+options.delay_turn_off, function() {
                    callback_turn_off && $.isFunction(options.callback_turn_off) && (options.callback_turn_off.call(this), callback_turn_off = !1)
                })
            }
            var defaults = {
                    color: "black",
                ...
                $body = $("body"),
                $elements = [],
                switch_selector = "#" + options.switch_selector + ", ." + options.switch_selector;
            if (this.each(function() {
                    var $this = $(this);
                    $elements.push($this)
                }), options.is_responsive) {
                var selectors = ["iframe[src*='player.vimeo.com']", "iframe[src*='www.youtube.com']", "iframe[src*='www.dailymotion.com']", "iframe[src*='www.kickstarter.com']", "object", "embed"];
                options.custom_player && selectors.push(options.custom_player);
                var $all_videos = $(this).parent().find(selectors.join(",")),
                    style = '<style type="text/css">\t\t\t          .fluid_width_video_wrapper {\t\t            width: 100%;\t\t\t            position: relative;\t\t            padding: 0;\t\t\t          }\t\t\t\t\t          .fluid_width_video_wrapper iframe,\t          .fluid_width_video_wrapper object,\t          .fluid_width_video_wrapper embed {\t            position: absolute;\t\t            top: 0;\t\t\t\t            left: 0;\t\t\t            width: 100%;\t\t\t            height: 100%;\t\t\t          }\t\t\t\t\t        </style>';
                $body.append(style), $all_videos.each(function() {
                    var $this = $(this);
                    if (!("embed" == this.tagName.toLowerCase() && $this.parent("object").length || $this.parent(".fluid_width_video_wrapper").length)) {
                        ...
                        $this.wrap('<div class="fluid_width_video_wrapper"></div>').parent(".fluid_width_video_wrapper").css("padding-top", 100 * aspectRatio + "%"), $this.removeAttr("height").removeAttr("width")
                    }
                })
            }
            var style = '<style type="text/css">\t\t\t        .allofthelights_bg {\t\t\t          position: absolute;\t\t          display: none;\t\t\t          background: ' + options.color + ";\t\t\t\t\topacity: " + options.opacity + ";\t\t\t\t\tz-index: " + options.z_index + ";\t\t\t\t}\t\t\t\t\t\t\t</style>";
            $body.append(style), $body.on("click", ".allofthelights_bg", function() {
                var callback_turn_on = !0;
                $(".allofthelights_bg").hide(+options.delay_turn_on, function() {
                    options.scrolling || $body.css("overflow", "auto"), callback_turn_on && $.isFunction(options.callback_turn_on) && (options.callback_turn_on.call(this), callback_turn_on = !1)
                })
            }).on("click", switch_selector, function() {
                options.scrolling || $body.css("overflow", "hidden"), calculating()
            }), $(window).on("resize", function() {
                $("div.allofthelights_bg").is(":visible") && ($("div.allofthelights_bg").remove(), calculating())
            })
        }
    }(jQuery),
    ...
    function(global, factory) {
        ...
        "use strict";
        var tl_ph = moment.defineLocale("tl", {
    ...
    function($) {
        FlipClock.Lang.Bulgarian = {
            ...
            minutes: "Минути",
            seconds: "Секунди"
        }, FlipClock.Lang.bg = FlipClock.Lang.Bulgarian, FlipClock.Lang["bg-bg"] = FlipClock.Lang.Bulgarian, FlipClock.Lang.bulgarian = FlipClock.Lang.Bulgarian
    }(jQuery),
    function($) {
        FlipClock.Lang.Bengali = {
            years: "বছর",
            months: "মাস",
            days: "দিন",
            hours: "ঘন্টার",
            minutes: "মিনিট",
            seconds: "সেকেন্ড"
        }, FlipClock.Lang.bn = FlipClock.Lang.Bengali, FlipClock.Lang["bn-in"] = FlipClock.Lang.Bengali, FlipClock.Lang.bengali = FlipClock.Lang.Bengali
    }(jQuery),
    function($) {
        FlipClock.Lang.Czech = {
            ...
            minutes: "Minuty",
            seconds: "Sekundy"
        }, FlipClock.Lang.cs = FlipClock.Lang.Czech, FlipClock.Lang["cs-cz"] = FlipClock.Lang.Czech, FlipClock.Lang.czech = FlipClock.Lang.Czech
    }(jQuery),
    function($) {
        ...
        }, FlipClock.Lang.el = FlipClock.Lang.Greek, FlipClock.Lang["el-gr"] = FlipClock.Lang.Greek, FlipClock.Lang.greek = FlipClock.Lang.Greek
    }(jQuery),
    function($) {
        FlipClock.Lang.Estonian = {
            years: "Aastad",
            months: "Kuud",
            days: "Päevad",
            hours: "Tunnid",
            minutes: "Minutid",
            seconds: "Sekundid"
        }, FlipClock.Lang.et = FlipClock.Lang.Estonian, FlipClock.Lang["et-es"] = FlipClock.Lang.Estonian, FlipClock.Lang.estonian = FlipClock.Lang.Estonian
    }(jQuery),
    function($) {
        FlipClock.Lang.Persian = {
            ...
            minutes: "دقیقه ها",
            seconds: "ثانیه ها"
        }, FlipClock.Lang.fa = FlipClock.Lang.Persian, FlipClock.Lang["fa-ir"] = FlipClock.Lang.Persian, FlipClock.Lang.persian = FlipClock.Lang.Persian
    }(jQuery),
    function($) {
        FlipClock.Lang.Hebrew = {
            ...
            minutes: "דקות",
            seconds: "שניות"
        }, FlipClock.Lang.he = FlipClock.Lang.Hebrew, FlipClock.Lang["he-il"] = FlipClock.Lang.Hebrew, FlipClock.Lang.hebrew = FlipClock.Lang.Hebrew
    }(jQuery),
    function($) {
        FlipClock.Lang.Hindi = {
            years: "वर्षों",
            months: "महीने",
            days: "दिन",
            hours: "घंटे",
            minutes: "मिनट",
            seconds: "सेकंड"
        }, FlipClock.Lang.hi = FlipClock.Lang.Hindi, FlipClock.Lang["hi-in"] = FlipClock.Lang.Hindi, FlipClock.Lang.hindi = FlipClock.Lang.Hindi
    }(jQuery),
    function($) {
        FlipClock.Lang.Croatian = {
            ...
            minutes: "Minute",
            seconds: "Sekunde"
        }, FlipClock.Lang.hr = FlipClock.Lang.Croatian, FlipClock.Lang["hr-hr"] = FlipClock.Lang.Croatian, FlipClock.Lang.croatian = FlipClock.Lang.Croatian
    }(jQuery),
    function($) {
        FlipClock.Lang.Hungarian = {
            ...
            minutes: "Perc",
            seconds: "Másodperc"
        }, FlipClock.Lang.hu = FlipClock.Lang.Hungarian, FlipClock.Lang["hu-hu"] = FlipClock.Lang.Hungarian, FlipClock.Lang.hungarian = FlipClock.Lang.Hungarian
    }(jQuery),
    function($) {
        FlipClock.Lang.Indonesian = {
            ...
            minutes: "Menit",
            seconds: "Detik"
        }, FlipClock.Lang.id = FlipClock.Lang.Indonesian, FlipClock.Lang["id-id"] = FlipClock.Lang.Indonesian, FlipClock.Lang.indonesian = FlipClock.Lang.Indonesian
    }(jQuery),
    function($) {
        FlipClock.Lang.Icelandic = {
            years: "Ár",
            months: "Mánuðir",
            days: "Dagar",
            hours: "Klukkutímar",
            minutes: "Mínútur",
            seconds: "Sekúndur"
        }, FlipClock.Lang.is = FlipClock.Lang.Icelandic, FlipClock.Lang["is-is"] = FlipClock.Lang.Icelandic, FlipClock.Lang.icelandic = FlipClock.Lang.Icelandic
    }(jQuery),
    function($) {
        FlipClock.Lang.Japanese = {
            ...
            minutes: "分",
            seconds: "秒"
        }, FlipClock.Lang.ja = FlipClock.Lang.Japanese, FlipClock.Lang["ja-jp"] = FlipClock.Lang.Japanese, FlipClock.Lang.japanese = FlipClock.Lang.Japanese
    }(jQuery),
    function($) {
        FlipClock.Lang.Georgian = {
            years: "წლები",
            months: "თვეები",
            days: "დღეები",
            hours: "საათები",
            minutes: "წუთები",
            seconds: "წამები"
        }, FlipClock.Lang.ka = FlipClock.Lang.Georgian, FlipClock.Lang["ka-ge"] = FlipClock.Lang.Georgian, FlipClock.Lang.georgian = FlipClock.Lang.Georgian
    }(jQuery),
    function($) {
        FlipClock.Lang.Korean = {
            ...
            minutes: "분",
            seconds: "초"
        }, FlipClock.Lang.ko = FlipClock.Lang.Korean, FlipClock.Lang["ko-kp"] = FlipClock.Lang.Korean, FlipClock.Lang.korean = FlipClock.Lang.Korean
    }(jQuery),
    function($) {
        FlipClock.Lang.Lithuanian = {
            years: "Metai",
            months: "Mėnesiai",
            days: "Dienos",
            hours: "Valandos",
            minutes: "Minutės",
            seconds: "Sekundės"
        }, FlipClock.Lang.lt = FlipClock.Lang.Lithuanian, FlipClock.Lang["lt-lt"] = FlipClock.Lang.Lithuanian, FlipClock.Lang.lithuanian = FlipClock.Lang.Lithuanian
    }(jQuery),
    function($) {
        FlipClock.Lang.Malay = {
            years: "Tahun",
            months: "Bulan",
            days: "Hari",
            hours: "Jam",
            minutes: "Minit",
            seconds: "Saat"
        }, FlipClock.Lang.ms = FlipClock.Lang.Malay, FlipClock.Lang["ms-my"] = FlipClock.Lang.Malay, FlipClock.Lang.malay = FlipClock.Lang.Malay
    }(jQuery),
    function($) {
        FlipClock.Lang.Norwegian = {
            years: "År",
            ...
            minutes: "Minutter",
            seconds: "Sekunder"
        }, FlipClock.Lang.nb = FlipClock.Lang.Norwegian, FlipClock.Lang["nb-no"] = FlipClock.Lang.Norwegian, FlipClock.Lang.norwegian = FlipClock.Lang.Norwegian
    }(jQuery),
    function($) {
        FlipClock.Lang.Polish = {
            ...
            minutes: "Minuty",
            seconds: "Sekundy"
        }, FlipClock.Lang.pl = FlipClock.Lang.Polish, FlipClock.Lang["pl-pl"] = FlipClock.Lang.Polish, FlipClock.Lang.polish = FlipClock.Lang.Polish
    }(jQuery),
    function($) {
        FlipClock.Lang.Romanian = {
            ...
            minutes: "minute",
            seconds: "secunde"
        }, FlipClock.Lang.ro = FlipClock.Lang.Romanian, FlipClock.Lang["ro-ro"] = FlipClock.Lang.Romanian, FlipClock.Lang.romanian = FlipClock.Lang.Romanian
    }(jQuery),
    function($) {
        FlipClock.Lang.Russian = {
            years: "Годы",
    ...
    function($) {
        FlipClock.Lang.Slovak = {
            ...
            minutes: "Minúty",
            seconds: "Sekundy"
        }, FlipClock.Lang.sk = FlipClock.Lang.Slovak, FlipClock.Lang["sk-sk"] = FlipClock.Lang.Slovak, FlipClock.Lang.slovak = FlipClock.Lang.Slovak
    }(jQuery),
    function($) {
        FlipClock.Lang.Slovenian = {
            ...
            minutes: "Minute",
            seconds: "Sekunde"
        }, FlipClock.Lang.sl = FlipClock.Lang.Slovenian, FlipClock.Lang["sl-si"] = FlipClock.Lang.Slovenian, FlipClock.Lang.slovenian = FlipClock.Lang.Slovenian
    }(jQuery),
    function($) {
        FlipClock.Lang.Albanian = {
            years: "Vite",
            months: "Muaj",
            days: "Ditë",
            hours: "Orë",
            minutes: "Minuta",
            seconds: "Sekonda"
        }, FlipClock.Lang.sq = FlipClock.Lang.Albanian, FlipClock.Lang["sq-al"] = FlipClock.Lang.Albanian, FlipClock.Lang.albanian = FlipClock.Lang.Albanian
    }(jQuery),
    function($) {
        FlipClock.Lang.Serbian = {
            years: "Godine",
            months: "Meseci",
            days: "Dani",
            hours: "Sati",
            minutes: "Minuti",
            seconds: "Sekunde"
        }, FlipClock.Lang.sr = FlipClock.Lang.Serbian, FlipClock.Lang["sr-rs"] = FlipClock.Lang.Serbian, FlipClock.Lang.serbian = FlipClock.Lang.Serbian
    }(jQuery),
    function($) {
        FlipClock.Lang.Thai = {
            years: "ปี",
            ...
            minutes: "นาที",
            seconds: "วินาที"
        }, FlipClock.Lang.th = FlipClock.Lang.Thai, FlipClock.Lang["th-th"] = FlipClock.Lang.Thai, FlipClock.Lang.thai = FlipClock.Lang.Thai
    }(jQuery),
    function($) {
        FlipClock.Lang.Tagalog = {
            years: "Mga Taon",
            months: "Mga Buwan",
            days: "Mga Araw",
            hours: "Mga Oras",
            minutes: "Minuto",
            seconds: "Segundo"
        }, FlipClock.Lang.tl = FlipClock.Lang.Tagalog, FlipClock.Lang["tl-ph"] = FlipClock.Lang.Tagalog, FlipClock.Lang.tagalog = FlipClock.Lang.Tagalog, FlipClock.Lang.tagalog = FlipClock.Lang.Tagalog
    }(jQuery),
    function($) {
        FlipClock.Lang.Turkish = {
            ...
            minutes: "Dakika",
            seconds: "Saniye"
        }, FlipClock.Lang.tr = FlipClock.Lang.Turkish, FlipClock.Lang["tr-tr"] = FlipClock.Lang.Turkish, FlipClock.Lang.turkish = FlipClock.Lang.Turkish
    }(jQuery),
    function($) {
        FlipClock.Lang.Ukrainian = {
            ...
            minutes: "Хвилини",
            seconds: "Секунди"
        }, FlipClock.Lang.uk = FlipClock.Lang.Ukrainian, FlipClock.Lang["uk-ua"] = FlipClock.Lang.Ukrainian, FlipClock.Lang.ukrainian = FlipClock.Lang.Ukrainian
    }(jQuery),
    function($) {
        FlipClock.Lang.Urdu = {
            years: "سال",
            ...
            minutes: "منٹ",
            seconds: "سیکنڈ"
        }, FlipClock.Lang.ur = FlipClock.Lang.Urdu, FlipClock.Lang["ur-pk"] = FlipClock.Lang.Urdu, FlipClock.Lang.urdu = FlipClock.Lang.Urdu
    }(jQuery),
    function($) {
        FlipClock.Lang.Vietnamese = {
            ...
            minutes: "Phút",
            seconds: "Giây"
        }, FlipClock.Lang.vi = FlipClock.Lang.Vietnamese, FlipClock.Lang["vi-vn"] = FlipClock.Lang.Vietnamese, FlipClock.Lang.vietnamese = FlipClock.Lang.Vietnamese
    }(jQuery),
    function($) {
        FlipClock.Lang.ChineseSimplified = {
            years: "年",
            months: "月",
            days: "日",
            hours: "小时",
            minutes: "分钟",
            seconds: "秒"
        }, FlipClock.Lang.zh = FlipClock.Lang.ChineseSimplified, FlipClock.Lang["zh-cn"] = FlipClock.Lang.ChineseSimplified, FlipClock.Lang.chinese = FlipClock.Lang.ChineseSimplified
    }(jQuery),
    function($) {
        FlipClock.Lang.ChineseTraditional = {
            years: "年",
            months: "月",
            days: "日",
            hours: "小時",
            minutes: "分鐘",
            seconds: "秒"
        }, FlipClock.Lang["zh-tw"] = FlipClock.Lang.ChineseTraditional, FlipClock.Lang["chinese-traditional"] = FlipClock.Lang.ChineseTraditional
    }(jQuery),
    function($, window, document, undefined) {
        "use strict";

        function Plugin(element, options) {
            this.element = element, this.settings = $.extend({}, defaults, options), this._defaults = defaults, this._name = pluginName, this._fields = [this.settings.alarm_audio, this.settings.alarm_radio, this.settings.alarm_input_youtube, this.settings.alarm_hours, this.settings.alarm_minutes, this.settings.alarm_snooze_minutes, this.settings.timer_minutes, this.settings.timer_seconds], this.init()
        }
        var pluginName = "onlineAlarmKur",
            defaults = {
                lang: $("html").prop("lang"),
                clock: $("#clock"),
                date: $("#date"),
                ...
                alarm_snooze_minutes: "alarm-snooze-minutes",
                alarm_remaining: "alarm-remaining",
                alarm_remaining_text: "alarm-remaining-text",
                alarm_audio: "alarm-audio",
                alarm_radio: "alarm-radio",
                alarm_radio_player: "alarm-radio-player",
                alarm_input_youtube: "alarm-input-youtube",
                alarm_output_youtube: "alarm-output-youtube",
                alarm_iframe_youtube: "alarm-youtube",
                pause: "pause",
                resume: "resume",
                start: "start",
                stop: "stop",
                ...
                timer_remaining_text: "timer-remaining-text",
                timer_minutes: "timer-minutes",
                timer_seconds: "timer-seconds",
                progress_container: "progress-container",
                stopwatch_container: "stopwatch-container",
                stopwatch_lap: "stopwatch-lap",
                stopwatch_default: "00:00:00.000",
                stopwatch_format: "HH:mm:ss.SSS",
                stopwatch_diff: [0],
                stopwatch_counter: 0,
                lap: "lap",
                lap_container: "lap-container",
                default_title: document.title,
                method: "audio"
            };
        $.extend(Plugin.prototype, {
            init: function() {
                this.setLanguage(), this.createTimer(), this.getChoices(), this.commonScripts()
            },
            setLanguage: function() {
                moment.locale(this.settings.lang)
            },
            commonScripts: function() {
                $('[data-toggle="tooltip"]').tooltip(), $("#lights").on("click", function() {
                    $("#floatingSocialShare").allofthelights()
                })
            },
            createTimer: function() {
                if (this.settings.clock !== !1) {
                    var time = moment();
                    this.settings.clock.html(time.format("HH:mm:ss")), this.settings.date.html(time.format("dddd, DD MMMM YYYY")), setTimeout(function() {
                        this.createTimer()
                    }.bind(this), 1e3)
                }
            },
            getChoices: function() {
                $.each(this._fields, function(key, value) {
                    var field = $("#" + value);
                    field.length && field.val(simpleStorage.get(value) || 0)
                })
            },
            setChoices: function() {
                $.each(this._fields, function(key, value) {
                    var field = $("#" + value);
                    field.length && simpleStorage.set(value, field.val())
                })
            },
            getSelectedAudio: function() {
                return $("option:selected", $("#" + this.settings.alarm_audio)).data("src")
            },
            getSelectedRadio: function() {
                return $("option:selected", $("#" + this.settings.alarm_radio)).data("src")
            },
            loadAudio: function() {
                "audio" === this.settings.method && (this.settings.howler = new Howl({
                    src: [this.getSelectedAudio()],
                    loop: !0,
                    html5: !0,
                    volume: 1
                }))
            ...
            playAudio: function() {
                this.settings.howler ? this.settings.howler._src !== this.getSelectedAudio() && (this.unloadAudio(), this.loadAudio()) : this.loadAudio(), this.settings.howler.play()
            },
            unloadAudio: function() {
                this.settings.howler && this.settings.howler.unload()
            },
            stopAudio: function() {
                this.settings.howler && this.settings.howler.stop()
            },
            playRadio: function() {
                this.stopRadio(), $("#radio_loading").removeClass("hidden"), this.settings.howler = new Howl({
                    src: this.getSelectedRadio(),
                    html5: !0,
                    format: ["mp3", "aac"],
                    onloaderror: function() {
                        $("#radio_loading").addClass("hidden"), $("#radio_warning").removeClass("hidden")
                    },
                    onload: function() {
                        $("#radio_warning").addClass("hidden"), $("#radio_loading").addClass("hidden")
                    }
                }), this.settings.howler.play()
            },
            stopRadio: function() {
                this.unloadAudio()
            },
            getYoutubeKeyword: function(random) {
                var $selector = $("#" + this.settings.alarm_input_youtube);
                return $selector.val() && 0 != $selector.val() || $selector.val(random), encodeURIComponent($selector.val())
            },
            getAjax: function(url, success) {
                var xhr = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
                return xhr.open("GET", url), xhr.onreadystatechange = function() {
                    xhr.readyState > 3 && 200 === xhr.status && success(xhr.responseText)
                }, xhr.setRequestHeader("X-Requested-With", "XMLHttpRequest"), xhr.send(), xhr
            },
            getYoutubeVideo: function(random) {
                var keyword = this.getYoutubeKeyword(random),
                    yt_url = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=" + keyword + "&maxResults=1&order=viewCount&key=AIzaSyC_7WaOg8CheYVL_sFYAqBGyuq8SWBcovg",
                    base = this;
                this.getAjax(yt_url, function(data) {
                    var response = $.parseJSON(data);
                    if (response.items.length > 0 && "undefined" != typeof response.items[0].id) {
                        var video_id = response.items[0].id.videoId,
                            video_title = response.items[0].snippet.title,
                            video_frame = "<iframe class='embed-responsive-item' src='https://www.youtube.com/embed/" + video_id + "?enablejsapi=1&origin=http://jylevergara.com/whichline-atwhattime&rel=0&loop=1&playlist=" + video_id + "' frameborder='0' type='text/html'></iframe>",
                            final = "<h3 class='video-title' id='title'>" + video_title + "</h3><div class='embed-responsive embed-responsive-16by9'>" + video_frame + "</div>";
                        $("#" + base.settings.alarm_output_youtube).html(final)
                    } else $("#" + base.settings.alarm_output_youtube).html("<div id='not-found'>" + $("body").data("youtube-not-found-text") + "</div>")
                })
            },
            callYoutubePlayer: function(func, args) {
                for (var iframes = document.getElementsByTagName("iframe"), src = "", i = 0; i < iframes.length; i += 1) src = iframes[i].getAttribute("src"), src && src.indexOf("youtube.com/embed") !== -1 && iframes[i].contentWindow.postMessage(JSON.stringify({
                    event: "command",
                    func: func,
                    args: args || []
                }), "*")
            ...
            playYoutube: function() {
                this.callYoutubePlayer("playVideo")
            },
            stopYoutube: function() {
                this.callYoutubePlayer("stopVideo")
            },
            disableOptions: function() {
                $("#" + this.settings.stop).removeClass("hidden").show(), $("#" + this.settings.pause).removeClass("hidden").show(), $("#" + this.settings.alarm_remaining_text).removeClass("hidden").show(), $("#" + this.settings.start).hide(), $("#" + this.settings.test).hide(), $.each(this._fields, function(key, value) {
                    var field = $("#" + value);
                    field.length && field.prop("disabled", !0).selectpicker("refresh")
                })
            },
            enableOptions: function() {
                $("#" + this.settings.alarm_remaining).empty(), $("#" + this.settings.alarm_remaining_text).addClass("hidden").hide(), $("#" + this.settings.pause).addClass("hidden").hide(), $("#" + this.settings.resume).addClass("hidden").hide(), $("#" + this.settings.stop).addClass("hidden").hide(), $("#" + this.settings.start).show(), $("#" + this.settings.test).show(), $.each(this._fields, function(key, value) {
                    var field = $("#" + value);
                    field.length && field.prop("disabled", !1).selectpicker("refresh")
                })
            },
            getAlarmTimerDuration: function() {
                var current = moment(),
                    time = moment().hour($("#" + this.settings.alarm_hours).val()).minute($("#" + this.settings.alarm_minutes).val()).second(0),
                    diff = time > current ? time.diff(current) : time.add(1, "days").diff(current),
                    duration = moment.duration(diff).asSeconds();
                return duration
            },
            getSnoozeDuration: function() {
                return 60 * parseInt($("#" + this.settings.alarm_snooze_minutes).val())
            },
            getTimerDuration: function() {
                return 60 * parseInt($("#" + this.settings.timer_minutes).val()) + parseInt($("#" + this.settings.timer_seconds).val())
            },
            startTimer: function(duration) {
                var base = this;
                this.settings.timer = $("#" + this.settings.alarm_remaining).FlipClock(duration, {
                    countdown: !0,
                    clockFace: "HourlyCounter",
                    language: this.settings.lang,
                    callbacks: {
                        stop: function() {
                            1e3 * duration - this.getElapsed() === 0 && base.shineOn()
                        },
                        interval: function() {
                            document.title = moment.utc(1e3 * duration - this.getElapsed()).format("HH:mm:ss") + " - " + base.settings.default_title
                        }
                    }
                })
            },
            startModule: function() {
                this.wakeUp(), this.disableOptions(), this.setChoices(), this.loadAudio()
            },
            stopModule: function() {
                this.wakeUp(), this.enableOptions(), document.title = this.settings.default_title
            },
            restartModule: function() {
                this.stopModule(), this.disableOptions()
            },
            shineOn: function() {
                switch ($("#" + this.settings.snooze).prop("disabled", !1), $("#" + this.settings.pause).addClass("hidden").hide(), $("#" + this.settings.resume).addClass("hidden").hide(), this.settings.method) {
                    case "audio":
                        this.playAudio();
                        break;
                    case "radio":
            ...
            wakeUp: function() {
                switch ($("#" + this.settings.snooze).prop("disabled", !0), this.settings.method) {
                    case "audio":
                        this.stopAudio();
                        break;
                    case "radio":
            ...
            startAlarm: function() {
                this.startModule(), this.startTimer(this.getAlarmTimerDuration())
            },
            snoozeAlarm: function() {
                this.settings.timer.stop(), this.restartModule(), this.startTimer(this.getSnoozeDuration())
            },
            stopAlarm: function() {
                this.settings.timer.stop(), this.stopModule()
            },
            getInitProgressBar: function() {
                return '<div class="progress-bar progress-bar-success" role="progressbar" aria-valuemax="100" aria-valuenow="0" aria-valuemin="0" style="width: 0%;"></div>'
            },
            startTimerModule: function() {
                this.startModule();
                var base = this,
                    total = this.getTimerDuration(),
                    destination = 1e3 * total,
                    $selector = $("#" + base.settings.timer_remaining),
                    $textSelector = $("#" + base.settings.timer_remaining_text),
                    currentPercent = 0;
                $("#" + base.settings.progress_container).removeClass("hidden"), $selector.append(this.getInitProgressBar()), this.settings.timer = $.countdown(function() {
                    var current = this.getTime(),
                        percent = Math.round(100 * (1 - current / destination).toFixed(2));
                    if ($textSelector.html(moment.utc(current).format("HH:mm:ss")), percent != currentPercent) {
                        currentPercent = percent;
                        var progressBar = $selector.find(".progress-bar");
                        progressBar.css("width", currentPercent + "%").attr("aria-valuenow", currentPercent).text(currentPercent + "%"), currentPercent > 33 && progressBar.removeClass("progress-bar-success").addClass("progress-bar-warning"), currentPercent > 66 && progressBar.removeClass("progress-bar-warning").addClass("progress-bar-danger")
                    }
                    this.isFinished() ? base.shineOn() : document.title = moment.utc(current).format("HH:mm:ss") + " - " + base.settings.default_title
                }, total)
            },
            stopTimerModule: function() {
                this.settings.timer.stop(), this.stopModule(), $("#" + this.settings.progress_container).addClass("hidden"), $("#" + this.settings.timer_remaining_text).html(""), $("#" + this.settings.timer_remaining).html("")
            },
            restartTimerModule: function() {
                this.settings.timer.stop(), $("#" + this.settings.timer_remaining_text).html(""), $("#" + this.settings.timer_remaining).html("").append(this.getInitProgressBar()), this.restartModule(), this.settings.timer.toggle()
            },
            pauseTimerModule: function() {
                $("#" + this.settings.pause).addClass("hidden").show(), $("#" + this.settings.resume).removeClass("hidden").show(), this.settings.timer.toggle()
            },
            resumeTimerModule: function() {
                $("#" + this.settings.pause).removeClass("hidden").show(), $("#" + this.settings.resume).addClass("hidden").show(), this.settings.timer.toggle()
            },
            resetStopwatchVariables: function() {
                document.title = this.settings.default_title, $("#" + this.settings.stopwatch_container).html(this.settings.stopwatch_default), $("#" + this.settings.stopwatch_lap).html(""), this.settings.stopwatch_counter = 0, this.settings.stopwatch_diff = [0]
            },
            initStopwatchModule: function() {
                var base = this;
                this.resetStopwatchVariables(), this.settings.stopwatch = $.stopwatch(function() {
                    var currentTime = this.getTime(),
                        lapTime = currentTime - base.settings.stopwatch_diff[base.settings.stopwatch_diff.length - 1];
                    $("#" + base.settings.stopwatch_container).html(moment.utc(currentTime).format(base.settings.stopwatch_format)), $("#" + base.settings.stopwatch_lap).html(moment.utc(lapTime).format(base.settings.stopwatch_format)), document.title = moment.utc(this.getTime()).format("HH:mm:ss") + " - " + base.settings.default_title
                }, !1)
            },
            startStopwatchModule: function() {
                this.settings.stopwatch.toggle(), $("#" + this.settings.snooze).prop("disabled", !1), $("#" + this.settings.lap).prop("disabled", !1), $("#" + this.settings.resume).addClass("hidden").hide(), $("#" + this.settings.pause).removeClass("hidden").show(), $("#" + this.settings.start).hide()
            },
            resetStopwatchModule: function() {
                this.settings.stopwatch.stop(), this.resetStopwatchVariables(), $("#" + this.settings.snooze).prop("disabled", !0), $("#" + this.settings.lap).prop("disabled", !0), $("#" + this.settings.resume).addClass("hidden").hide(), $("#" + this.settings.pause).addClass("hidden").hide(), $("#" + this.settings.start).show(), $("#" + this.settings.lap_container).removeClass("margin-top-20").addClass("hidden").hide().find("tbody").html(""), $("#" + this.settings.lap_container + " th").find("svg").remove(), $("#" + this.settings.lap_container + " th").prepend('<svg viewBox="0 0 16 28" xmlns="http://www.w3.org/2000/svg" class="svg-icon icon-sort"><path d="M16 17c0 0.266-0.109 0.516-0.297 0.703l-7 7c-0.187 0.187-0.438 0.297-0.703 0.297s-0.516-0.109-0.703-0.297l-7-7c-0.187-0.187-0.297-0.438-0.297-0.703 0-0.547 0.453-1 1-1h14c0.547 0 1 0.453 1 1zM16 11c0 0.547-0.453 1-1 1h-14c-0.547 0-1-0.453-1-1 0-0.266 0.109-0.516 0.297-0.703l7-7c0.187-0.187 0.438-0.297 0.703-0.297s0.516 0.109 0.703 0.297l7 7c0.187 0.187 0.297 0.438 0.297 0.703z"></path></svg>')
            },
            pauseStopwatchModule: function() {
                this.settings.stopwatch.toggle(), $("#" + this.settings.pause).addClass("hidden").show(), $("#" + this.settings.resume).removeClass("hidden").show(), $("#" + this.settings.lap).prop("disabled", !0)
            },
            resumeStopwatchModule: function() {
                this.settings.stopwatch.toggle(), $("#" + this.settings.pause).removeClass("hidden").show(), $("#" + this.settings.resume).addClass("hidden").show(), $("#" + this.settings.lap).prop("disabled", !1)
            },
            lapStopwatchModule: function() {
                var currentTime = this.settings.stopwatch.getTime();
                this.settings.stopwatch_counter++, this.settings.stopwatch_diff.push(currentTime);
                var lapTime = this.settings.stopwatch_diff[this.settings.stopwatch_diff.length - 1] - this.settings.stopwatch_diff[this.settings.stopwatch_diff.length - 2];
                $("#" + this.settings.lap_container).removeClass("hidden").addClass("margin-top-20").show(), $("#" + this.settings.lap_container).find("tbody").prepend($("<tr>").append('<td data-sort-value="' + this.settings.stopwatch_counter + '"># ' + this.settings.stopwatch_counter.toLocaleString(this.settings.lang) + "</td>").append('<td data-sort-value="' + lapTime + '">' + moment.utc(lapTime).format(this.settings.stopwatch_format) + "</td>").append('<td data-sort-value="' + currentTime + '">' + moment.utc(currentTime).format(this.settings.stopwatch_format) + "</td>"))
            }
        }), $.fn[pluginName] = function(options) {
            return this.each(function() {
                $.data(this, "plugin_" + pluginName) || $.data(this, "plugin_" + pluginName, new Plugin(this, options))
